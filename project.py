        ...
        try:
            ...
            if rule_display == "y":
                print("\tBulls and Cows is a code-breaking game for two players.\n" +
                      ...
                      "\tFor each digit in a correct place guessed by the guesser, the other player declares 'Bull'.\n" +
                      "\tFor each digit in an incorrect place guessed by the guesser, the other player declares 'Cows'.\n" +
                      ...
                      "\tPLEASE NOTE THAT IN MY VERSION OF THE GAME, THE CODE WILL NOT CONTAIN ANY ZEROES!\n")
